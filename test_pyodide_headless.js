...
async function testPyodideHeadless() {
    console.log('🚀 Starting Headless Pyodide Tests');
    console.log('=' * 50);
    ...
    try {
        ...
        console.log('\n🧪 Test 1: Initializing Pyodide');
        pyodide = await loadPyodide({
            indexURL: "https://cdn.jsdelivr.net/pyodide/v0.24.1/full/"
        });
        console.log('✅ Pyodide initialized successfully');
        
        // Test 2: Test package loading
        console.log('\n🧪 Test 2: Testing Package Loading');
        try {
            await pyodide.loadPackage(['requests']);
            console.log('✅ Requests package loaded successfully');
        } catch (error) {
            console.log('⚠️ Requests package not available, using fallback');
        }
...
`;
        ...
        // Test get_panels
        const panelsResult = pyodide.runPython('sith.get_panels()');
        console.log(`✅ get_panels(): ${JSON.stringify(panelsResult)}`);
        
        // Test 5: Test error handling
        console.log('\n🧪 Test 5: Testing Error Handling');
        
        // Test invalid panel number
        const invalidResult = pyodide.runPython('sith.open_panel(99)');
        console.log(`✅ Invalid panel (99): ${JSON.stringify(invalidResult)}`);
        
        // Test 6: Test script execution context
        console.log('\n🧪 Test 6: Testing Script Execution Context');
...
`;
        ...
        // Test 7: Test asyncio issues
        console.log('\n🧪 Test 7: Testing asyncio Issues');
...
`;
        ...
        // Test 8: Test module scope persistence
        console.log('\n🧪 Test 8: Testing Module Scope Persistence');
...
`;
        ...
        pyodide.runPython(scopeTest);
        console.log('✅ Module scope persistence test completed');
        
        // Test 9: Test complex operations
        console.log('\n🧪 Test 9: Testing Complex Operations');
...
`;
        ...
        console.log('\n' + '=' * 50);
        console.log('🏁 All headless Pyodide tests completed successfully!');
        console.log('\n📋 Test Summary:');
        console.log('✅ Pyodide initialization');
        console.log('✅ Package loading (requests fallback)');
        ...
        console.log('✅ Module scope persistence');
...
// Run the tests
testPyodideHeadless().catch(console.error);